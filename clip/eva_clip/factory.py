...
def load_checkpoint(model, checkpoint_path, model_key="model|module|state_dict", strict=True):
    ...
    # resize_clip_pos_embed(state_dict, model)
    if model.visual.blocks[0].mlp.fc1.out_features!=state_dict["visual.blocks.0.mlp.fc1.weight"].shape[0]:
        for layer in model.visual.blocks:
            layer.mlp.fc1 = nn.Linear(layer.mlp.fc1.in_features, state_dict["visual.blocks.0.mlp.fc1.weight"].shape[0])
            layer.mlp.fc2 = nn.Linear(state_dict["visual.blocks.0.mlp.fc1.weight"].shape[0], layer.mlp.fc2.out_features)
