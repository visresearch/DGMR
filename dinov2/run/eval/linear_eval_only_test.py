...
class Evaluator:
    ...
    def __call__(self):
        from dinov2.eval.linear import main_only_test

        self._setup_args()
        main_only_test(self.args)
...
def main():
    description = "Submitit launcher for pruned DINOv2 linear evaluation"
    ...
    submit_jobs(Evaluator, args, name="pruned dinov2:linear")
    return 0
