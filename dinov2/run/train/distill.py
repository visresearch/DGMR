...
from dinov2.train.distill import get_args_parser as get_train_args_parser
...
class Trainer(object):
    ...
    def __call__(self):
        from dinov2.train.distill import main as train_main
...
def main():
    ...
    submit_jobs(Trainer, args, name="dinov2:distill")
    return 0
